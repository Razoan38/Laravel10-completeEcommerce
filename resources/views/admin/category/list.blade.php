                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <a href="{{ route('category.edit',['id' => $valu->id ]) }}" class="btn btn-primary">Edit</a>
                          <a href="{{ route('category.delate',['id' => $valu->id ] ) }}" class="btn btn-danger">Delate</a>
