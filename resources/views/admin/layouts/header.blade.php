      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="{{asset('/')}}public/admin/assets/img/user1-128x128.jpg" alt="User Avatar" class="img-size-50 mr-3 img-circle">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
                ...
                <a href="{{ route('admin.category.list') }}" class="nav-link @if(Request::segment(2) == 'category') active @endif">
                  <i class="nav-icon fas  fa-list-alt"></i>
                  <p>
                    Category
            ...
            <li class="nav-item">
                {{-- <a href="{{ url('admin/category/list') }}" class="nav-link @if(Request::segment(2) == 'product') active @endif"> --}}
                <a href="{{ route('admin.sub_category.list') }}" class="nav-link @if(Request::segment(2) == 'sub_category') active @endif">
                  <i class="nav-icon fas  fa-list-alt"></i>
                  <p>
                   Sub Category
